...
class Solution:
    ...
    def robotSim(self, commands, obstacles):
        ...
        obstacles = dict(zip(obstacles, [None]*len(obstacles)))
        facing = 'up'
        pos  = [0,0]
        max_d = 0
        def getD(pos):
        ...
        for c in commands:
            ...
            if c == -1:
                ...
                if facing == 'up':
                    for i in range(c):
                        if tuple([pos[0], pos[1]+1]) not in obstacles:
                            pos[1] += 1
                            # print(pos)
                        else:
                            # print('ob=', [pos[0], pos[1]+1])
                            break
                    # print('.  ', pos)
                    d = getD(pos)
                    if d > max_d:
                    ...
                    for i in range(c):
                        if tuple([pos[0]-1, pos[1]]) not in obstacles:
                            pos[0] -= 1
                            # print(pos)
                        else:
                            # print('ob=', [pos[0]-1, pos[1]])
                            break
                    d = getD(pos)
                    if d > max_d:
                        max_d = d
...
# print(s.robotSim(commands, obstacles) == 5140)

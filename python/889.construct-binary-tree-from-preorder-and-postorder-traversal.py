...
# pre = [3,4,1,2]
# post = [1,4,2,3]
# print(s.constructFromPrePost(pre, post)) #[3,4,2,1]
...
# pre = [3,2,5,4,1]
# post = [5,1,4,2,3] #[3,2,null,5,4,null,null,1]
# print(s.constructFromPrePost(pre, post))
...
print(s.constructFromPrePost(pre, post)) #[1,10,3,2,null,9,5,4,null,null,null,null,null,8,null,6,null,7]
